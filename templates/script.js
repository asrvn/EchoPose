function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}const { TimelineMax, TweenMax, Power0 } = window;
...
class VideoPlayer {
  ...
  constructor(container, src) {_defineProperty(this, "indicators", []);_defineProperty(this, "buildMarkup",
    ...
    });_defineProperty(this, "seek",

    () => {
      if (this.timeline) {
        this.timeline.seek(this.video.currentTime);
      }
    });_defineProperty(this, "bindStuff",
    ...
    });this.container = container;this.buildMarkup(src);this.bindStuff();} /**
